					...
					<div class="row justify-content-center">
                            ...
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-papaya(8).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                                        <a href="#" class="product-name">PAPAYA</a>
                                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-onion(6).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-carrot(7).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-mango(2).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                                        <a href="#" class="product-name">MANGO</a>
                                    </div>
                                </div>
								<div class="enquiry-button-div">
									<button class="btn-enquiry-now btn Enquiry-btn mfp-iframe mfp-iframe-btn " data-bs-toggle="modal" data-toggle="modal" data-bs-target="#exampleModal2" data-target="#exampleModal2">Enquiry now</button>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-apple(4).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-capsicum.jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                                        <a href="#" class="product-name">CAPSICUM</a>
                                    </div>
                                </div>
								<div class="enquiry-button-div">
									<button class="btn-enquiry-now btn Enquiry-btn mfp-iframe mfp-iframe-btn " data-bs-toggle="modal" data-toggle="modal" data-bs-target="#exampleModal2" data-target="#exampleModal2">Enquiry now</button>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-avacado(1).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                                        <a href="#" class="product-name">AVACADO</a>
                                    </div>
                                </div>
								<div class="enquiry-button-div">
									<button class="btn-enquiry-now btn Enquiry-btn mfp-iframe mfp-iframe-btn " data-bs-toggle="modal" data-toggle="modal" data-bs-target="#exampleModal2" data-target="#exampleModal2">Enquiry now</button>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="product-item">
                                <div class="product-inner">
                                    <div class="product-thumb">
                                        <img src="assets/images/product/product-anaar(3).jpg" alt="product">
                                    </div>
                                    <div class="product-content">
                                        <a href="#" class="product-name">POMEGRANATE</a>
                                    </div>
                                </div>
                            </div>
							<div class="enquiry-button-div">
